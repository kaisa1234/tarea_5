...
def main():
    ...
    group_name = "motoman_hc20"  #planing group
    ...
    box_name = "base_hc20"
    scene.add_box(box_name, aux_pose, size=(0.5, 0.5, dist_kuka_piso))

    aux_pose = geometry_msgs.msg.PoseStamped()
    aux_pose.header.frame_id = "base_link"
    aux_pose.pose.orientation.w = 2.0
    aux_pose.pose.position.x = 0
    aux_pose.pose.position.y = -1
    aux_pose.pose.position.z = 0.2
    box_name = "obstaculo"
    scene.add_box(box_name, aux_pose, size=(0.50, 0.50, 3))
