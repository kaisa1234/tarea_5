...
motoman_hc20 = MoveGroupPythonInterface("motoman_hc20")     
joint_list, cartesian_position, cartesian_orientation = motoman_hc20.get_position()
print(cartesian_position)

motoman_hc20.go_to_home()

motoman_hc20.scale_ROT = 1.0
motoman_hc20.joints_move("j3","reverse")                                   
motoman_hc20.cartesian_pos("x","forward")
motoman_hc20.cartesian_pos("z","reverse")     
motoman_hc20.joints_move("j0","reverse")
motoman_hc20.scale_LIN = 0.25 
motoman_hc20.joints_move("j3","forward")         
motoman_hc20.joints_move("j2","forward")
motoman_hc20.cartesian_pos("x","forward")
motoman_hc20.joints_move("j1","forward")
